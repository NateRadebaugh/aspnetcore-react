    ...
    <div>
      ...
      <ul>
        ...
        <li>
          ...
          <a href="http://nextjs.org">Next.JS</a> for client-side code
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          the development server from <code>next</code> runs in the background
      ...
      <p>
        ...
        based on <code>next</code>. If you open a command prompt in that
        directory, you can run <code>npm</code> commands such as{" "}
